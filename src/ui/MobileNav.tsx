...
export default function MobileNav(){
  ...
  return (
    <nav className="fixed bottom-3 left-3 right-3 z-40 rounded-3xl bg-white/90 backdrop-blur shadow-candy px-3 py-2 flex justify-around">
      <Link to="/" className={`px-3 py-2 rounded-2xl ${pathname==='/'?'bg-candy-100 text-candy-700':'text-pirate/70'}`}>Listes</Link>
      <Link to="/about" className={`px-3 py-2 rounded-2xl ${pathname==='/about'?'bg-candy-100 text-candy-700':'text-pirate/70'}`}>À propos</Link>
